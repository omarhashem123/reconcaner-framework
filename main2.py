...
os.system("mkdir "+ args.o + "/recon")
os.system("mkdir "+ args.o + "/recon/subdomains")
file_for_scope = open(args.o + "/recon/subdomains/subdomains", "a")
for i in scope_medium:
	file_for_scope.write(i+"\n")
	print(111)
file_for_scope.close()
os.system("subfinder -dL " + args.o + "/recon/subdomains/subdomains -o " + args.o + "/recon/subdomains/live_subdomains")
#[+]----------------------------------------------------------------------------[+]

#use httpx to extract unique live subdomains to enter it to scanners and wayback and dirsearch
...
def dirsearch(sub):
    os.system("python3 webtool/dirsearch/dirsearch.py --full-url --random-agent -e '*' -u " + sub)
...
with concurrent.futures.ThreadPoolExecutor(max_workers=10) as e:
    ...
    #e.map(smuggler, scope_dirsearch)
    #e.map(getjs, nothing)
...
for i in scope_wappalyzer:
    ...
    i = i.replace("https://", "")
    try:
        os.system("cat webtool/dirsearch/reports/*/* | grep " + i + "| sort -u >> " + args.o + "/other/dirsearch/dirsearch")
    except:
        pass
...
def jaeles_fuzz(nothing):
    ...
    os.system("jaeles scan -c 100 -s ~/.jaeles/base-signatures/fuzz/common/CRLF.yaml -U " + args.o + "/recon/all_endpoints_and_gf/gf_parameters/parms_endpoints -o " + args.o + "/jaeles/fuzz")
    os.system("jaeles scan -c 100 -s ~/.jaeles/base-signatures/fuzz/sqli/sqli-polyglot.yaml -U " + args.o + "/recon/all_endpoints_and_gf/gf_parameters/sqli -o " + args.o + "/jaeles/fuzz -v")
    os.system("jaeles scan -c 100 -s ~/.jaeles/base-signatures/fuzz/sqli/sqli-polyglot-path.yaml -U " + args.o + "/recon/all_endpoints_and_gf/gf_parameters/parms_endpoints -o " + args.o + "/jaeles/fuzz")
    os.system("jaeles scan -c 100 -s ~/.jaeles/base-signatures/fuzz/lfi/lfi-path-01.yaml -U " + args.o + "/recon/all_endpoints_and_gf/gf_parameters/parms_endpoints -o " + args.o + "/jaeles/fuzz")
    os.system("jaeles scan -c 100 -s ~/.jaeles/base-signatures/fuzz/lfi/lfi-param-base.yaml -U " + args.o + "/recon/all_endpoints_and_gf/gf_parameters/path_traversal -o " + args.o + "/jaeles/fuzz")
    os.system("jaeles scan -c 100 -s ~/.jaeles/base-signatures/fuzz/ssti/template-injection.yaml -U " + args.o + "/recon/all_endpoints_and_gf/gf_parameters/ssti -o " + args.o + "/jaeles/fuzz")
    os.system("jaeles scan -c 100 -s ~/.jaeles/base-signatures/fuzz/common/ssrf.yaml -p 'dest=" + args.ct + "' -U " + args.o + "/recon/all_endpoints_and_gf/gf_parameters/ssrf -o " + args.o + "/jaeles/fuzz")
    os.system("jaeles scan -c 100 -s ~/.jaeles/base-signatures/fuzz/common/OS_command_injection.yaml -p 'ssrf=" + args.ct + "' -U " + args.o + "/recon/all_endpoints_and_gf/gf_parameters/rce -o " + args.o + "/jaeles/fuzz")
    os.system("jaeles scan -c 100 -s ~/.jaeles/base-signatures/fuzz/random/common-error.yaml -U " + args.o + "/recon/all_endpoints_and_gf/gf_parameters/parms_endpoints -o " + args.o + "/jaeles/fuzz")
    os.system("jaeles scan -c 100 -s ~/.jaeles/base-signatures/fuzz/open-redirect/open-redirect-lite.yaml -U " + args.o + "/recon/all_endpoints_and_gf/gf_parameters/parms_endpoints -o " + args.o + "/jaeles/fuzz")
    os.system("jaeles scan -c 100 -s ~/.jaeles/base-signatures/fuzz/open-redirect/open-redirect-param-base.yaml -U " + args.o + "/recon/all_endpoints_and_gf/gf_parameters/redirect -o " + args.o + "/jaeles/fuzz")
    os.system("jaeles scan -c 100 -s ~/.jaeles/base-signatures/fuzz/common/host-header-injection.yaml -p 'dest=test.com' -U " + args.o + "/recon/subdomains/httpx_subs -o " + args.o + "/jaeles/fuzz")

def nuclei_fuzz(nothing):
    os.system("nuclei -t ~/nuclei-templates/vulnerabilities/generic/error-based-sql-injection.yaml -tags fuzz -l " + args.o + "/recon/all_endpoints_and_gf/gf_parameters/sqli -bs   50 -o " + args.o + "/nuclei/fuzz/error-based-sql-injection")
    os.system("nuclei -t ~/nuclei-templates/vulnerabilities/generic/crlf-injection.yaml -l " + args.o + "/recon/all_endpoints_and_gf/gf_parameters/parms_endpoints -bs 50 -o " + args.o + "/nuclei/fuzz/crlf-injection")
    os.system("nuclei -t ~/nuclei-templates/vulnerabilities/generic/open-redirect.yaml -l " + args.o + "/recon/all_endpoints_and_gf/gf_parameters/parms_endpoints -bs 50 -o " + args.o + "/nuclei/fuzz/open-redirect")
    os.system("nuclei -t ~/nuclei-templates/nuclei-templates/fuzzing/adminer-panel-fuzz.yaml -tags fuzz -l " + args.o + "/recon/subdomains/httpx_subs -bs 50 -o " + args.o + "/nuclei/fuzz/adminer-panel-fuzz")
    os.system("nuclei -t ~/nuclei-templates/vulnerabilities/generic/top-xss-params-omar.yaml -l " + args.o + "/recon/all_endpoints_and_gf/gf_parameters/parms_endpoints -bs 50 -o " + args.o + "/nuclei/fuzz/top-xss-params")
    os.system("nuclei -t ~/nuclei-templates/vulnerabilities/generic/basic-xss-prober.yaml -l " + args.o + "/recon/subdomains/httpx_subs -bs 50 -o " + args.o + "/nuclei/fuzz/top-xss-params")
    os.system("nuclei -t ~/nuclei-templates/headless/postmessage-tracker.yaml -headless -tags headless -l " + args.o + "/recon/all_endpoints_and_gf/gf_parameters/parms_endpoints -bs 100 -o " + args.o + "/nuclei/fuzz/postmessage-tracker")
